...
import fr.si2m.rp.swift.inputs.InputIbanBicReader;
import fr.si2m.rp.swift.orm.IbanBic;
import fr.si2m.rp.swift.outputs.OutputIbanBicWriter;
...
public class LoadIbanBic {
	...
	public ExitValue run() {
		...
		while (!lInput.isEof()) {
			try {
				...
				unprocessedLogger.info("l.{}\t{}", lIndex, lLigneInError);
				logger.error("Erreur de lecture de ligne de la ligne '{}\t{}'\n{}", lIndex, lLigneInError, e);
			}
		}
	...
	public static void main(String[] args) {
		try {
			LoadIbanBic lSwiftRefLoader = new LoadIbanBic("/home/nta/views/svn/SWIFT/SwifRefLoader/src/main/resources/db.properties", Mode.FULL);
